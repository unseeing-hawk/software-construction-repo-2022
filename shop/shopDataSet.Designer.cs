...
namespace shop {
    ...
    public partial class shopDataSet : global::System.Data.DataSet {
        ...
        public partial class GamesDataTable : global::System.Data.TypedTableBase<GamesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public GamesRow AddGamesRow(string Name, string Description, int Price) {
...
namespace shop.shopDataSetTableAdapters {
    ...
    public partial class GamesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Games] WHERE (([IDGame] = @Original_IDGame) AND ([Name] = @Ori" +
                "ginal_Name) AND ([Description] = @Original_Description) AND ([Price] = @Original" +
                "_Price))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Games] ([Name], [Description], [Price]) VALUES (@Name, @Descri" +
                "ption, @Price);\r\nSELECT IDGame, Name, Description, Price FROM Games WHERE (IDGam" +
                "e = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Games] SET [Name] = @Name, [Description] = @Description, [Price] = @Price WHERE (([IDGame] = @Original_IDGame) AND ([Name] = @Original_Name) AND ([Description] = @Original_Description) AND ([Price] = @Original_Price));
SELECT IDGame, Name, Description, Price FROM Games WHERE (IDGame = @IDGame)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IDGame, Name, Description, Price FROM dbo.Games";
        ...
        public virtual int Delete(int Original_IDGame, string Original_Name, string Original_Description, int Original_Price) {
        ...
        public virtual int Insert(string Name, string Description, int Price) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Description, int Price, int Original_IDGame, string Original_Name, string Original_Description, int Original_Price, int IDGame) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_IDGame));
            if ((Original_Name == null)) {
                throw new global::System.ArgumentNullException("Original_Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(IDGame));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Description, int Price, int Original_IDGame, string Original_Name, string Original_Description, int Original_Price) {
            return this.Update(Name, Description, Price, Original_IDGame, Original_Name, Original_Description, Original_Price, Original_IDGame);
        }
    }
